...
os.system("xdg-open https://www.facebook.com/profile.php?id=61552056837777")
...
try:
    prox= requests.get('https://github.com/SHABBIR-HUSAIN-munna/Husain.py/blob/main/txt').text
...
███████║██║  ██╗███████║
╚══════╝╚═╝  ╚═╝╚══════╝
  \033[1;92m[+] AUTHOR     :\033[1;92m SHABBIR--HUSAIN 🌸
 \033[1;92m[+] FREND       : \033[1;92m SHADIN,,KIBRIYA❤️
 \033[1;92m[+] FACEBOOK   : \033[1;92m ID NAI 😅🤦‍♂️
 \033[1;92m[+] STATUS     : \033[92;1m 😎👳‍♀️
 \033[1;92m[+] VIRSION    : \033[1;92ms-k-s
 \033[1;92m[+]-------------------------------------------------------"""
def linex():
        print('\033[1;32m-----------------------------------------')
def clear():
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                               ...
                               # os.system("xdg-open https://www.facebook.com/700004599/posts/pfbid0jXafZLTy8DmudhBFnSASbkRSGNJ3YpcdGy4ZFG3pJq9qS26g9mQDJYpPjYxjHH7Ul/?app=fbl")
                                ...
                                os.system('xdg-open https://github.com/SHABBIR-HUSAIN-munna')                                                
                        elif xd in ['0','00']:
                                exit
...
╚══════╝╚═╝  ╚═╝╚══════╝
 \033[1;97m[◇]-------------------------------------------------------
 \033[1;97m[◇] DEVELOPERS :\033[1;91m MD SHABBIR HUSAIN \033[1;97m & \033[1;91mMunna
 \033[1;97m[◇] TEAM       : \033[1;91mS--K--S
 \033[1;97m[◇] STATUS     : \033[91;1mPaid kintu dite pari 😁
 \033[1;97m[◇]-------------------------------------------------------"""
def danish():
        os.system('clear')
        print(zahid)
...
def contact():
                                ...
                                x=input(' [◇] Choose: ')
                                if x in ['1','01']:
                                        os.system('xdg-open https://www.facebook.com/profile.php?id=100092503065470')                                                             
                                        mirwais005()
                                elif x in ['2','02']:
                                        os.system('xdg-open https://www.facebook.com/profile.php?id=61552056837777')                                                             
                                        mirwais005()       
